  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <header className="mx-auto flex h-20 max-w-7xl items-center justify-between gap-3 px-5 sm:px-6 lg:px-8">
        <Link
          href="/"
          className="flex shrink-0 items-center gap-2 rounded-xl px-1 py-2 transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary sm:gap-3"
          aria-label="FlowDesk"
        >
          <div className="flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-xl shadow-lg shadow-primary/20 sm:h-11 sm:w-11">
            <Image
