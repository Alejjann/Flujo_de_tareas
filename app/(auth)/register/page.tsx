          ...
          <section className="relative hidden min-h-[720px] overflow-hidden border-r border-white/10 p-10 lg:flex lg:flex-col lg:justify-between">
            <div>
              <div className="flex items-center gap-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-300 to-sky-500 text-lg font-black text-slate-950 shadow-lg shadow-cyan-500/20">
                  F
                </div>
              ...
              <div className="mt-16 max-w-md">
                ...
                <p className="mt-6 max-w-sm text-base leading-7 text-slate-300">
                  Crea tu cuenta y reúne tareas, objetivos y avances
                  en un único espacio diseñado para ayudarte a
                  concentrarte.
                </p>
              </div>
            </div>
          ...
          <section className="flex min-h-[620px] items-center p-5 sm:p-8 lg:p-10">
            <div className="mx-auto w-full max-w-md">
              ...
              <div className="mb-9 flex items-center justify-center gap-2.5 lg:hidden">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-300 to-sky-500 text-base font-black text-slate-950 shadow-lg shadow-cyan-500/20">
                  F
                </div>
